...
public class Livro extends Publicacoes {
    ...
    public void print(JTextArea txt) {
        ...
        txt.append("Autor           : "+this.autor      +"\n");
        txt.append("ISBN            : "+this.ISBN       +"\n\n");
    ...
    public void read ()  {
        ...
        j.setTitle(":: Lendo dados do livro");
        j.setSize(470, 330);
        j.setLayout(lay);
    ...
    public void actionPerformed (ActionEvent e) {
        if (e.getActionCommand().equals("Ok")){
            ...
            this.autor = tf4.getText();
            this.ISBN = tf5.getText();
            j.dispose();
